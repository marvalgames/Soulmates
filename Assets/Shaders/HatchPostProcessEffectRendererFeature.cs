...
public sealed class HatchPostProcessEffectRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        HatchPostProcessEffectVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<HatchPostProcessEffectVolumeComponent>();
