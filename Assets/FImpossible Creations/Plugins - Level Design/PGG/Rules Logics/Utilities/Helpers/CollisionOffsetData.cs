...
namespace FIMSpace.Generating.Rules.Helpers
{
    public struct CollisionOffsetData
    {
        ...
        public CollisionOffsetData(SpawnData spawn, Vector3? cellOffset = null, bool getAll = false, bool applyPrefabScale = true)
        {
            parent = spawn;
            ...
            Vector3 prePos = spawn.Prefab.transform.position;
            Quaternion preRot = spawn.Prefab.transform.rotation;
            ...
            if (applyPrefabScale) bounds.size = Vector3.Scale(bounds.size, spawn.Prefab.transform.localScale);
            ...
            spawn.Prefab.transform.position = prePos;
            spawn.Prefab.transform.rotation = preRot;
