...
namespace FIMSpace.Generating.Rules.Collision
{
    public class SR_CheckCollisionInCell : SpawnRuleBase, ISpawnProcedureType
    {
        ...
        [Space(5)]
        //[PGG_SingleLineTwoProperties( "Direct", 120, 50, 18 )]
        ...
        public bool ApplyPrefabScale = true;
        ...
        public override void CellInfluence(FieldSetup preset, FieldModification mod, FieldCell cell, ref SpawnData spawn, FGenGraph<FieldCell, FGenPoint> grid, Vector3? restrictDirection = null)
        {
            ...
            CollisionOffsetData thisOffset = new CollisionOffsetData(spawn, null, AllMeshesBounds, ApplyPrefabScale);
            Vector3 checkPos = cell.WorldPos(preset);

            if (Direct)
                checkPos += thisOffset.boundsWithSpawnOff.center + spawn.GetRotationOffset() * OffsetColliderOrigin;
            else
                checkPos += thisOffset.boundsWithSpawnOff.center + OffsetColliderOrigin;
            ...
            for (int s = 0; s < checkSpawns.Count; s++)
            {
                ...
                CollisionOffsetData checkCol = new CollisionOffsetData(sp, null, false, ApplyPrefabScale);
        ...
        public override void OnDrawDebugGizmos(FieldSetup preset, SpawnData spawn, FieldCell cell, FGenGraph<FieldCell, FGenPoint> grid)
        {
            ...
            if (Direct)
                pos += thisOffset.boundsWithSpawnOff.center + spawn.GetRotationOffset() * OffsetColliderOrigin;
            else
                pos += thisOffset.boundsWithSpawnOff.center + OffsetColliderOrigin;
