...
namespace FIMSpace.Generating
{
    ...
    public partial class FieldSetupComposition
    {
        ...
        public void PrepareWithCurrentlyChoosed( UnityEngine.Object owner, FieldPlanner fieldPlanner, bool changePrepared = true )
        {
            if( GenType == EPGGGenType.FieldSetup ) PrepareWith( owner, fieldPlanner, Setup, changePrepared );
            else if( GenType == EPGGGenType.Modificator ) PrepareWith( owner, fieldPlanner, JustMod, changePrepared );
            else if( GenType == EPGGGenType.ModPack ) PrepareWith( owner, fieldPlanner, JustModPack, changePrepared );
            else if( GenType == EPGGGenType.Prefab ) PrepareWithPrefabList( owner, fieldPlanner, changePrepared );
        }

        public void PrepareWith( UnityEngine.Object owner, FieldPlanner fieldPlanner, FieldSetup setup, bool changePrepared = true )
        {
            ResetSetup( fieldPlanner, changePrepared );
        ...
        public void PrepareWith( UnityEngine.Object owner, FieldPlanner fieldPlanner, FieldModification setup, bool changePrepared = true )
        {
            ResetSetup( fieldPlanner, changePrepared );
        ...
        public void PrepareWith( UnityEngine.Object owner, FieldPlanner fieldPlanner, ModificatorsPack setup, bool changePrepared = true )
        {
            ResetSetup( fieldPlanner, changePrepared );
        ...
        public void PrepareWithPrefabList( UnityEngine.Object owner, FieldPlanner fieldPlanner, bool changePrepared = true )
        {
            ResetSetup( fieldPlanner, changePrepared );
        ...
        void ResetSetup( FieldPlanner fieldPlanner, bool changePreapred = true )
        {
            ...
            if( changePreapred ) Prepared = true;
