...
namespace FIMSpace.Generating.Planning.PlannerNodes.Field.Special
{
    public class PR_CustomTightPlacement : PR_TightPlacement
    {
        ...
        public override Vector2 NodeSize { get { return new Vector2( 252, _EditorFoldout ? 274 : 238 ); } }
        ...
        protected override void OnAfterPlacementIteration()
        {
            ...
            else
            {
                ...
                {
                    if( WantedAligns.GetInputValue <= 1 )
                    {
                    ...
                    else if( checker.CountCellsOfInDir( alignToCheckerEdges, checker.RootRotation * Vector3.forward ) < WantedAligns.GetInputValue )
                    {
                        skipIteration = true;
                    }
                }
